...
def run(
    ...
    stream_sra: bool | None = typer.Option(
        None,
        "--stream-sra",
        help="Experimentally stream paired ENA FASTQs into Deacon (requires --experimental and --skip-fastqc)",
        rich_help_panel=PANEL_CORE,
    ),
    # -------------------------------------------------------------------------
    # Reference Paths
    ...
    max_concurrent_downloads: int | None = typer.Option(
        ...
        help="Maximum concurrent SRA or ENA retrieval tasks (default: 3)",
        rich_help_panel=PANEL_ANALYSIS,
    ),
    # -------------------------------------------------------------------------
    # Read Preprocessing
