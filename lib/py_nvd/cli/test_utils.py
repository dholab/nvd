...
class TestFormatDuration:
    ...
    def test_boundary_59_to_60_seconds(self):
        """Boundary between seconds-only and minutes+seconds."""
        assert format_duration(59) == "59s"
        assert format_duration(60) == "1m 0s"

    def test_boundary_3599_to_3600_seconds(self):
    ...
    def test_fractional_hours_truncated(self):
    ...
    def test_negative_infinity_raises_assertion_error(self):
