/**
 * Directory resolution for NVD pipeline local-data paths.
 *
 * This class handles the logic for resolving state_dir and taxonomy_dir
...
class NvdDirs {
    ...
    /** Legacy hits directory path retained for compatibility during cleanup */
     ...
     *   - hits_dir is unused legacy compatibility output
     *
    ...
    private static NvdDirs resolveStateless(nfParams, nfLog) {
        ...
        // Legacy hits path retained until the directory API is simplified.
