...
workflow PREPROCESS_READS {
    ...
    ch_sra_accessions  // tuple(sample_id, platform, accession) when stream_sra is enabled
    ...
    // -------------------------------------------------------------------------
    ch_streamed_target_reads = DEACON_ENRICH_SRA_READS.out.reads.map {
        sample_id, platform, read_structure_file, reads, input_read_count, enriched_read_count ->
