...
class TestIsInTargetLineage:
    ...
    def test_include_children_ancestor_match(self, test_taxonomy_sqlite: Path, mock_taxonomy_open):
    ...
    def test_include_children_no_match(self, test_taxonomy_sqlite: Path, mock_taxonomy_open):
