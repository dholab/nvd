...
def main():
    parser = argparse.ArgumentParser(description="Upload BLAST CSVs to LabKey.")
    ...
    log_entries = [
        f"LabKey BLAST Upload Log - {datetime.now()}",
    ...
    log_entries += [
        ...
        "BLAST UPLOAD COMPLETE" if upload_enabled else "BLAST SIMULATION COMPLETE - No actual upload performed"
    ]
